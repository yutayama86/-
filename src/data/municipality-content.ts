...
export const MUNICIPALITY_CONTENT: Record<string, MuniContent> = {
  ...
  tsuchiura: {
    ...
    gourmet: [
      { name: 'れんこん', desc: '霞ヶ浦沿岸は全国トップクラスのれんこん産地。' },
  ...
  hitachinaka: {
    ...
    intro: '国営ひたち海浜公園のネモフィラ・コキアで世界的に有名。那珂湊の魚市場と、全国トップクラスの干し芋産地としても知られます。',
    spots: [
    ...
    gourmet: [
      { name: '干し芋', desc: '生産量全国トップクラス。しっとり甘い茨城の冬の味覚。' },
  ...
  kamisu: {
    ...
    intro: '鹿島灘に沿う工業と農業の街。ピーマンの生産量は全国トップクラス。港公園の展望塔や海岸が親しまれています。',
    spots: [
      { name: '港公園', desc: '高さ52mの展望塔から鹿島港と太平洋を一望。' },
      { name: '日川浜海岸', desc: '広々とした砂浜。海水浴やサーフィンに。' },
    ],
    gourmet: [{ name: 'ピーマン', desc: '生産量全国トップクラス。神栖の看板野菜。' }],
  },
  namegata: {
    catch: 'さつまいもと、二つの湖。',
  ...
  hokota: {
    catch: 'メロン全国トップクラスの、海と畑。',
    intro: 'メロンの生産量全国トップクラスを誇る街。鹿島灘の海岸線と、豊かな農の恵みが広がります。',
    spots: [
      { name: '鹿島灘海岸', desc: 'まっすぐ続く砂浜と、サーフィンが楽しめる海。' },
    ],
    gourmet: [
      { name: 'メロン', desc: '生産量全国トップクラス。初夏の鉾田メロンは格別。' },
  ...
  oarai: {
    ...
    spots: [
      ...
      { name: 'アクアワールド茨城県大洗水族館', desc: 'サメの飼育種数全国トップクラス。子どもから大人まで楽しめる。' },
