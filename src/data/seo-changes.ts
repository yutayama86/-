...
export const SEO_CHANGES: SeoChange[] = [
  ...
  },
  {
    ...
    kind: 'on-page',
    change: 'ACLE初戦当日向けに、要点枠を当日版にし、当日券（鹿チケ9/15 20:00まで・場外販売所）と来場者鹿BIGを反映。過去の販売期限9/14 23:59を撤去し、前日会見を試合背景として1項目追加',
    queries: ['鹿島 ニューカッスル', '鹿島アントラーズ ACL 当日券'],
    commit: '976a1cd',
    note: '試合後は結果を入れると次戦（9/19川崎戦）がNEXT MATCHに自動で上がる',
  },
  {
