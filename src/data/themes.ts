...
export const THEMES: Record<Theme['slug'], Theme> = {
  ...
  kouyou: {
    ...
    status: {
      ...
      rows: [
        ['いまの状態', '9月18日（金）から「きて みて さわって コキアカーニバル」が始まります。この時期のコキアはまだ緑で、公園公式は10月上旬頃から徐々に紅葉が始まると案内しています。'],
        ['紅葉始め', '10月10日頃（公園公式の予想、9月17日時点）'],
        ['紅葉見頃', '10月15日頃（同上）。例年、紅葉のピークは1週間〜10日程とされています。'],
        ['色の移り方', '緑と赤のグラデーション → 紅葉 → 赤と茶のグラデーション、と変わっていくと案内されています。'],
